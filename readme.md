# Power equipment drone inspection dataset 12500 images full coverage of 5 types of defects supported

# Body

Power Equipment UAV Inspection Data Set, 12500 images, covers all five categories of defects, supports YOLO format.
This is suitable for friends who are engaged in power inspections, defect detection, and AI algorithm training. The dataset is large in size, with comprehensive labels, ready to use directly.
order now and it will be sent instantly without refund or exchange.

CrossarmCorrosion
PoleTopDamage
ConductorBindingLoosenedOrDetached is a term used in the field of electrical engineering to describe a condition where the conductor bindings are loose or detached. This can occur due to various reasons such as vibration, temperature changes, or physical damage to the conductor bindings. In this condition, the conductor bindings may not be securely attached to the conductors, which can lead to potential safety hazards and reduced performance of the electrical system.
Part of the original description was in Chinese and has been omitted.

The missing cover of Parallel Groove Clamp
